...
metadata_csv_path = 'streamlod/data/incomplete/meta1.csv'
metadata_csv_path_bis = 'streamlod/data/incomplete/meta1bis.csv'
metadata_csv_path2 = 'streamlod/data/incomplete/meta2.csv'
process_json_path = 'streamlod/data/incomplete/process1.json'
process_json_path_bis = 'streamlod/data/incomplete/process1bis.json'
process_json_path2 = 'streamlod/data/incomplete/process2.json'
